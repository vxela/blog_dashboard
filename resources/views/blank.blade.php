...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vendors/mazer/assets/css/main/app-dark.css') }}">
...
<link rel="stylesheet" href="{{ asset('vendors/mazer/assets/css/shared/iconly.css') }}">
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.html"><img src="{{ asset('vendors/mazer/assets/images/logo/logo.svg') }}" alt="Logo" srcset=""></a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">
                                This is space for title description of the page keep it dude.
                            </p>
                        </div>
